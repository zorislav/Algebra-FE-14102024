...
const noResultsMessage = "No songs found. Please try a different search term.";
...
function displayResults(results) {
  ...
  const html = limitedResults
    .map((song) => `<li>${song.trackName} - ${song.artistName}</li>`)
    .join("");
...
function displayErrorMessage() {
  resultsContainer.innerHTML =
    "<li>Error loading songs. Please try again later.</li>";
}
