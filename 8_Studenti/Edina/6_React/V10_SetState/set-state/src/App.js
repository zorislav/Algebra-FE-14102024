...
export default class App extends React.Component {
  ...
  btnClickHandler = () => {
    const newUsers = this.state.users.map((user) => {
      return { ...user, years: user.years + 1 }; //samo svojstvo years povečavamo za 1, a svojstvo name ostaje isto
    });
    //map funkcija transformira niz element po element, a rezultat je NOVI NIZ
    this.setState({ users: newUsers }); //s ovim mijenjamo stari niz users na novi niz newUsers
  };
