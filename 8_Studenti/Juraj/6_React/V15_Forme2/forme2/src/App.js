  ...
  render() {
    ...
    return (
      <>
        ...
        {users.map((user, index) => <User key={user.id} name={user.name} years={user.years} onNameChange={(event) => this.nameChangeHandler(event, index)} onDeleteUser={() => this.deleteUserHandler(index)} />)}
        <hr/>
