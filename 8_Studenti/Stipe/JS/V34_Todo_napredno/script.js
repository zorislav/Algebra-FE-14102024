...
(
    ...
    function Todo(){
        ...
        async function loadFromFirebase(){
            ...
            const answer = confrim("Replace current list");
        ...
        async function getData(){
            ...
            const response = await fetch("https://algebra1-1ee7b-default-rtdb.europe-west1.firebasedatabase.app/todo.json");
        ...
        async function postData(text){
            ...
            try{
                ...
                await fetch("https://algebra1-1ee7b-default-rtdb.europe-west1.firebasedatabase.app/todo.json",{
                 method: "DELETE",
